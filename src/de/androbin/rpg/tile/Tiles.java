...
public final class Tiles
{
	...
	{
		final JSONObject props = (JSONObject) parseJSON( "tile/" + type + ".json" ).orElseGet( JSONObject::new );
		final BufferedImage image = ImageUtil.loadImage( "tile/" + props.getOrDefault( "image", type ) + ".png" );
