	...
	public static final Event.Builder BUILDER = args ->
	                                          {
		                                          ...
		                                          {
			                                          case 3 :
				                                          return new TeleportEvent( args[ 0 ], new Point( Integer.parseInt( args[ 1 ] ), Integer.parseInt( args[ 2 ] ) ) );
														  
			                                          case 2 :
				                                          return new TeleportEvent( new Point( Integer.parseInt( args[ 0 ] ), Integer.parseInt( args[ 1 ] ) ) );
		                                          }
