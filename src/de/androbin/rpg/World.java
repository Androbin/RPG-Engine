...
public class World
{
	...
	public final void addEntity( final Entity entity )
	{
		...
		{
			Logger.getGlobal().log( Level.WARNING, "World " + name + " had Entity attached twice: " + entity );
		}
	...
	{
		return objects.parallelStream().filter( o -> o.getBounds().contains( x, y ) ).findAny().orElse( null );
	}
